...
public class Assets extends AssetManager {
    ...
    public TextureRegion derecha, izquierda, disparo;
    ...
    void loadAnimations(){
        ...
        derecha = atlas.findRegion("boton_android_derecha");
        izquierda = atlas.findRegion("boton_android_izquierda");
        disparo = atlas.findRegion("boton_android_disparo");
    }
}
